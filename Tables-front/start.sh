...
function install_essentials(){
	...
	curl -sL https://deb.nodesource.com/setup_12.x | bash - >> output.log 2>&1
...
function serve_project(){
	ng serve --aot --host 0.0.0.0 --disableHostCheck --proxy-config /code/proxy-config.json --base-href /debug/
}
